...
public interface HelloListener extends ParseTreeListener {
	/**
	 * Enter a parse tree produced by {@link HelloParser#setExpression}.
	 * @param ctx the parse tree
	 */
	void enterSetExpression(HelloParser.SetExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link HelloParser#setExpression}.
	 * @param ctx the parse tree
	 */
	void exitSetExpression(HelloParser.SetExpressionContext ctx);
	/**
